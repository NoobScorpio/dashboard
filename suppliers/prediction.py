...
def getPredictionGraph(old, new):
    ...
    fig.update_layout(
        ...
        # width=2000,
        # height=480,
        title_text=f'<b>Sales Forecast</b>',
        title_font_color=titleColor,
        plot_bgcolor='rgba(0, 0, 0, 0)',)
...
def getCustPredictions():
    return [
                ...
                html.Div([
                    ...
                    dbc.Row(
                        dbc.Col(
                            ...
                            ], width=12, className="d-flex justify-content-end p-5")),

                    dbc.Row(dbc.Col(html.Div(id='predcitionSupTimeLine',
        ...
        dbc.Row([
            ...
            html.Div([
                    html.Div(id='supPredcitionBars', style={
                        # 'margin': '10px',
                        'padding':'10px',
                        'box-shadow': '0px 0px 5px 0px rgba(0,0,0,0.2)',
                        'background-color': 'white',
                    ...
                    ], className="mt-2 col-sm-12 col-md-12 col-lg-12 col-xl-5"),
            html.Div([
                    ...
                    ], className="mt-2 col-sm-12 col-md-12 col-lg-12 col-xl-7"),
...
@app.callback(
    Output("predcitionSupTimeLine", "children"),
    Output("supPredcitionBars", "children"),

    [Input("predictionSupDropDown", "value")],
)
...
def getCustPredictionLayout():
    return html.Div(
        ...
        children=[
            dbc.Tabs(
                [
                    dbc.Tab(label="Supplier 1", tab_id="1"),
                    dbc.Tab(label="Supplier 2", tab_id="118"),
                    dbc.Tab(label="Supplier 3", tab_id="42"),
                    dbc.Tab(label="Supplier 4", tab_id="2"),
                    # dbc.Tab(label="Customer 7", tab_id="7"),
                ],
                id="sup-pred-tabs",
                active_tab="1",
            ),
            html.Div(id="sup-pred-tab-content", className="p-0"),
            #
...
@app.callback(
    Output("sup-pred-tab-content", "children"),
    [Input("sup-pred-tabs", "active_tab")],
)
